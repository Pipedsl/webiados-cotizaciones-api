...
- **"El lead no está entre los leads recientes":** el Core no permite pedir un lead por número exacto,
  así que se busca entre los ~200 más recientes. Si el lead es muy viejo, no aparece; conviértelo antes.
